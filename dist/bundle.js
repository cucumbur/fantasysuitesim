...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__states_Boot__ = __webpack_require__(/*! ./states/Boot */ 124);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__states_Splash__ = __webpack_require__(/*! ./states/Splash */ 127);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__states_Info__ = __webpack_require__(/*! ./states/Info */ 126);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__states_Game__ = __webpack_require__(/*! ./states/Game */ 125);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__config__ = __webpack_require__(/*! ./config */ 121);
...
class Game extends __WEBPACK_IMPORTED_MODULE_2_phaser___default.a.Game {
  ...
  constructor() {
    ...
    const width = __WEBPACK_IMPORTED_MODULE_7__config__["a" /* default */].gameWidth;
    const height = __WEBPACK_IMPORTED_MODULE_7__config__["a" /* default */].gameHeight;
    ...
    this.state.add('Info', __WEBPACK_IMPORTED_MODULE_5__states_Info__["a" /* default */], false);
...
/* exports used: default */
/*!*******************************************!*\
  !*** ./src/external/phaser-scrollable.js ***!
  \*******************************************/
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* Adapted with (very minimal) modificationns from Yaniv Nagar at https://github.com/trueicecold/phaser-scrollable */
...
ScrollableArea.prototype.beginMove = function () {
		// console.log('phaser-scrollable begin move')
...
ScrollableArea.prototype.endMove = function () {
		// console.log('phaser-scrollable end move')
...
ScrollableArea.prototype.stop = function () {
		...
		// My own little extra bit of functionality
		this.pressedDown = false;
};
...
/* harmony default export */ __webpack_exports__["a"] = ScrollableArea;
...
class Item extends __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Sprite {
  constructor({ state, game, x, y, asset, name }) {
    ...
    this.events.onInputDown.add(function (e) {
      ...
      if (this.isPlaced) {
        ...
        // When the item is dragged from inventory
    ...
    this.events.onDragStop.add(() => {
      ...
      } else if (y < inventoryBackground.y && y >= roomBackground.y && !this.isPlaced) {
        // The case where its dragged from inventory to room
        console.log('inventory -> room drag');
        this.isPlaced = true;
      } else if (y < inventoryBackground.y && y >= roomBackground.y && this.isPlaced) {
        // The case where its dragged from room to room
        console.log('room -> room drag');
      } else {
        // The case where it is dragged from the room back into the inventory
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_phaser__ = __webpack_require__(/*! phaser */ 31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_phaser___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_phaser__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__lib_Item__ = __webpack_require__(/*! ../lib/Item */ 123);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__external_phaser_scrollable__ = __webpack_require__(/*! ../external/phaser-scrollable */ 122);
/* globals __DEV__ */
...
/* harmony default export */ __webpack_exports__["a"] = class extends __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.State {
  ...
  create() {
    ...
    this.dragWindow = new __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Rectangle(0, 0, 640, 768); // experimantal. move to beginning if brogen and change y from roomBackground.x to 0

    // Scrollable
    this.scroller = this.game.add.existing(new __WEBPACK_IMPORTED_MODULE_2__external_phaser_scrollable__["a" /* default */](0, roomBackground.y + roomBackground.height, 640, 128, { verticalScroll: false, verticalWheel: false }));
    ...
    let fountainItem = new __WEBPACK_IMPORTED_MODULE_1__lib_Item__["a" /* default */]({
      state: this,
      game: this.game,
    ...
    //   }, 1000, e)
    // }, this)
    gameState.items.push(new __WEBPACK_IMPORTED_MODULE_1__lib_Item__["a" /* default */]({
      state: this,
      game: this.game,
      x: calcItemInitialScrollX(),
      y: 0,
...
/* harmony default export */ __webpack_exports__["a"] = class extends __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.State {
  init(isStartOfGame, infoText) {
    ...
    if (isStartOfGame) {
      const introText = ['You are the producer on a TV show, The Achelor.', 'The show is down to the last few contestants.', 'The Achelor and one of the contestants, namehere, are staying in the Fantasy Suite tonight.', 'They\'re both into each other, but they need the mood to be right to hook up.', 'The more you get them in the mood, the more they\'ll do, and the budget you will have for next season.', 'Using your starting budget of $5000 for Season 1, try to quickly place items in the room that', 'fulfill the whims of both people.', 'If you do well, you might get renewed.'];
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_phaser__ = __webpack_require__(/*! phaser */ 31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_phaser___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_phaser__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils__ = __webpack_require__(/*! ../utils */ 128);
...
module.exports = __webpack_require__(/*! /Users/cucumbur/dev/fantasysuitesim/src/main.js */119);
